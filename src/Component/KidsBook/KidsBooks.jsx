...
const KidsBooks = () => {
    ...
    return (
        <div>
            <div className="hero h-[550px] my-5 rounded-xl bg-orange-100">
  <div className="hero-content flex-col lg:flex-row-reverse">
    <img className='lg:px-32 px-20' src='https://images-us.bookshop.org/ingram/9780399226168.jpg?height=500&v=v2' />
    <div className='ml-4 lg:ml-20 space-y-12'>
      <h1 className="text-xl lg:text-5xl font-bold"> Most Gifted Children  Books: Emotions and Growth Mindset </h1>
    <div className="flex gap-10 items-center ">
    <button className="btn  hover:text-black text-white 
    font-xl bg-pink-600 "> <a href="#kidsBookList">See all Books</a> </button> 
    <h1 className=" flex gap-2  font-bold"><FaArrowLeft></FaArrowLeft>  Click this and see magic !! </h1>
    </div>
    </div>
  </div>
</div>
